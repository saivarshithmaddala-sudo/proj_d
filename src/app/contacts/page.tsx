...
export default function AdminConsole() {
  ...
  return (
    <div className="space-y-8">
      {/* Page Header */}
      <section className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 py-2 border-b border-white/5 pb-6">
            ...
            return (
              ...
              >
                ...
                <div className="bg-neutral-900/40 p-5 border-b border-white/5 flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div className="space-y-2.5">
                    <div className="flex items-center gap-2.5 flex-wrap">
                      ...
                      <code className="text-[11px] font-mono text-neutral-400 bg-neutral-950/60 px-2 py-0.5 rounded border border-white/5 select-all" title="Full DB Identifier">
                        ID: {primary.id}
                      </code>
                    </div>
                ...
                {secondaries.length > 0 ? (
                  <div className="p-5 pl-8 md:pl-12 bg-neutral-950/10 space-y-4 relative">
                    {/* Connecting vertical line */}
                    <div className="absolute left-6 md:left-8 top-0 bottom-8 border-l border-dashed border-teal-500/10"></div>
                  ...
                  <div className="p-4 pl-8 text-left text-neutral-600 font-mono text-[10px] italic bg-neutral-950/5">
